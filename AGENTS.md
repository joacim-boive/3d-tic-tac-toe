...
- **Logic self-tests** run without a browser via `tsx`: `npm run check:win`, `check:pick`, `check:ai`, `check:room`, `check:notify`. Useful for validating game/AI/room-code/notify logic quickly.
